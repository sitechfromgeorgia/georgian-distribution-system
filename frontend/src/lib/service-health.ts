...
export async function checkServiceHealth(): Promise<ServiceStatus> {
  ...
  try {
    ...
    try {
      ...
      logger.test('Database Health Check', 'FAIL', { error: error instanceof Error ? error.message : 'Unknown' })
    }
    ...
    try {
      ...
      logger.test('Auth Health Check', 'FAIL', { error: error instanceof Error ? error.message : 'Unknown' })
    }
    ...
    try {
      ...
      logger.test('Storage Health Check', 'FAIL', { error: error instanceof Error ? error.message : 'Unknown' })
    }
    ...
    try {
      ...
      logger.test('Realtime Health Check', 'FAIL', { error: error instanceof Error ? error.message : 'Unknown' })
    }
