...
console.log('DEBUG: SUPABASE_SERVICE_KEY provided:', !!SUPABASE_SERVICE_KEY)
if (SUPABASE_SERVICE_KEY) console.log('DEBUG: Key length:', SUPABASE_SERVICE_KEY.length)
...
async function applyRLSFix() {
  try {
    ...
    // Read the migration file - ADJUSTED PATH for frontend/ directory
