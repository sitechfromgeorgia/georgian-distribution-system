@echo off
REM ========================================
REM Quick Environment Files Setup
REM ========================================
...
if not exist ".env.production.new" (
    echo [ERROR] .env.production.new not found!
    goto :error
)

if not exist "frontend\.env.local.new" (
...
echo Please check the files exist and try again.
echo.
pause
exit /b 1
